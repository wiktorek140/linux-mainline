...
static const struct power_supply_desc fan5404x_chg_desc = {
    .name = "battery",
    .type = POWER_SUPPLY_TYPE_BATTERY,
	.get_property = fan5404x_batt_get_property,
	.set_property = fan5404x_batt_set_property,
	.properties = fan5404x_batt_properties,
	.num_properties = ARRAY_SIZE(fan5404x_batt_properties),
	.external_power_changed = fan5404x_external_power_changed,
	.property_is_writeable = fan5404x_batt_is_writeable,
};
				...
				const struct i2c_device_id *id)
{
	...
	rc = power_supply_register(chip->dev, &fan5404x_chg_desc, &usb_psy_cfg);
	if (rc < 0) {
		dev_err(&client->dev,
